...
from ababe.stru.clarifier import AtomRemoveClarifier
...
class TestAtomRemoveClarifier(unittest.TestCase):
    ...
    def setUp(self):
        ...
        center = np.array([0.041667, 0.666667, 0.875000])
        ele = Specie('Zn')
        r = 2
        self.nearZnClarifier = AtomRemoveClarifier(center, r, Specie('Zn'))
